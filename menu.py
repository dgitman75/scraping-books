...
def print_best_books():
    ...
    # for descending  do best_books = sorted(books, key=lambda x: x.rating * -1)[:10]
...
def print_cheapest_books():
    ...
    # for descending  do best_books = sorted(books, key=lambda x: x.price * -1)[:10]
    for book in cheapest_books:
        print(book)

books_generator = (x for x in books)

print(books_generator)
